 ...
 */
export default function bodyMerge(body1: TFetcherBodyMergeable, body2: TFetcherBodyMergeable): TFetcherBodyMergeable {
  ...
  if (isInstanceofUrlSearchParams(body1) || isInstanceofUrlSearchParams(body2)) {
    return mergeTypeSearchParams(cloneTypeUrlSearchParams(body1), cloneTypeUrlSearchParams(body2));
  }
